                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Id</th> <th>Type</th> <th>Name</th> <th>Address</th> <th>Active_flag</th> <th>Identification</th>
                    ...
                    <tbody>
                        @foreach($clients as $client)
                            <tr>
                                ...
                                <td>{{$client->id}}</td> <td>{{$client->type}}</td> <td>{{$client->name}}</td> <td>{{$client->address}}</td> <td>{{$client->active_flag}}</td> <td>{{$client->identification}}</td>
