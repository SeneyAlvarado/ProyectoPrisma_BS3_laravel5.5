...
<div style="padding:10px;">
    ...
    <div class="">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form style="display:inline" action="{{ route('client_contacts.destroy', $contact->id) }}"
                                method="POST" style="display: inline;"
                                onsubmit="return confirm('¿Desea eliminar el contacto {{$contact->contact_name}}?');">
                                {{csrf_field()}}
                                <input type="hidden" name="_method" value="DELETE">
                                <button type="submit"
                                    class="btn btn-success style-btn-success btn-size btn-sm">Eliminar</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
        ...
        @else
        <a class="btn btn-success style-btn-registry" href="{{ route('client_contacts.create', $id) }}"
            style="margin-bottom: 10px; ">Agregar </a>
