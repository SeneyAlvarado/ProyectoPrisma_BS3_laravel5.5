            ...
            <div class="container-fluid">
                <div class="">
                    <form method='POST' action='{{ route("orders.store") }}' onsubmit="return check_clients_branch_select(this)">
                        ...
                        <!-- Here we had the advanced payment, it was moved to the Work at the modal -->
                                            ...
                                            <div class="row justify-content-center">
                                                    <div class="col-md-5" >
                                                            ...
                                                            <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                                                <input id="dateInput_add" type="text"  name="date" class="form-control datetimepicker-input" data-target="#datetimepicker4"/>
                                                ...
                                                <div class="row justify-content-center" style="margin-top:20px;">
                                                    <div class="col-md-10">
                                                        <label for="observation_add"><strong>Observaciones Adicionales</strong></label>
                                                        <textarea class="form-control" value="" rows="5" id="observation_add" name= "observation_add"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin-top:20px;">
                                                        <div class="col-md-4 offset-md-2">
                                                            ...
                                                            <div class="input-group " id="advance_payment_add">
                                                                ...
                                                                <label>Sí</label>
                                                                <label>
                                                                    <input type="radio" value="1" class="radiobox" name="advance_payment_add">
                                                                </label>
                                                               
                                                                    <label>
                                                                    <label style="margin-left:20px;">No</label>
                                                                        <input type="radio" value="0" class="radiobox" name="advance_payment_add" checked>
                                                                    </label>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 offset-md-1" >
                                                                ...
                                                                <div class="input-group " id="priority_add">
                                                                    ...
                                                                    <label>Sí</label>
                                                                    <label>
                                                                        <input type="radio" value="1" class="radiobox" name="priority_add">
                                                                    </label>
                                                                   
                                                                        <label>
                                                                        <label style="margin-left:20px;">No</label>
                                                                            <input type="radio" value="0" class="radiobox" name="priority_add" checked>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="modal-body">
                                            <div class="row justify-content-center">
                                                    <div class="col-md-5" >
                                                            <label for="date-field"><strong>Fecha de entrega</strong></label>
                                                            <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                                                <input id="dateInput_edit" type="text"  name="date" class="form-control datetimepicker-input" data-target="#datetimepicker4"/>
                                                                <div class="input-group-append" data-target="#datetimepicker4" data-toggle="datetimepicker">
                                                                    <div class="input-group-text"><span class="glyphicon glyphicon-calendar"></span></div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row justify-content-center" style="margin-top:20px;">
                                                    <div class="col-md-10">
                                                        <label for="observation_edit"><strong>Observaciones Adicionales</strong></label>
                                                        <textarea class="form-control" value="" rows="5" id="observation_edit" name= "observation_edit"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin-top:20px;">
                                                        <div class="col-md-4 offset-md-2">
                                                            ...
                                                            <div class="input-group " id="advance_payment_edit">
                                                                ...
                                                                <label>Sí</label>
                                                                <label>
                                                                    <input type="radio" value="1" class="radiobox" name="advance_payment_edit">
                                                                </label>
                                                               
                                                                    <label>
                                                                    <label style="margin-left:20px;">No</label>
                                                                        <input type="radio" value="0" class="radiobox" name="advance_payment_edit" checked>
                                                                    </label>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 offset-md-1" >
                                                                ...
                                                                <div class="input-group " id="priority_edit">
                                                                    ...
                                                                    <label>Sí</label>
                                                                    <label>
                                                                        <input type="radio" value="1" class="radiobox" name="priority_edit">
                                                                    </label>
                                                                   
                                                                        <label>
                                                                        <label style="margin-left:20px;">No</label>
                                                                            <input type="radio" value="0" class="radiobox" name="priority_edit" checked>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                            </div>
