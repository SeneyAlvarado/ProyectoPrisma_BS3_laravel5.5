                ...
                <div class="">
                    <form method='POST' action='{{ route("orders.store") }}' enctype="multipart/form-data" onsubmit="return check_clients_branch_select(this)">
                                ...
                                <div class="col-md-5" >
                                        ...
                                        <div class="row justify-content-center">
                                                <div class="col-md-4 col-md-offset-2" style="margin-top:5px;  ">
                                                    <a class='btn btn-success btn-block' onclick="addWorkToTable();" type='submit'>Agregar Trabajo</a>
                                                </div>
                        ...
                        <div class="col-md-4 col-md-offset-2" style="margin-top:5px;  ">
                            ...
                            <button id="nextBtn" name="xD" onclick="nextPrev(1)" class='btn btn-success btn-block'></button>
                        </div>
                        <div class="col-md-4" style="margin-top:5px; ">
