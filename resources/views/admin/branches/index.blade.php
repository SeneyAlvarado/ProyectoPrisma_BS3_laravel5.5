        ...
        <form action="{{ route('branch.store') }}" method="POST">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <label for="name"><strong>Nombre de sucursal</strong></label>
                        <input placeholder="Nombre" class="nombre margin-lft form-control" name = "name" type="text" id="nombre_recinto" required pattern="[0-9a-zA-Z áéíóúÁÉÍÓÚñÑ]{2,48}" title="No se permiten símbolos en este campo"> 
                    </div>
                    </div>
                    <div class="row justify-content-center">
                    <div class="col-md-4">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <form method = 'POST' action='{{ route("branch.update") }}'>
                    ...
                    <div class="col-md-8">
                    <label for="name"><strong>Nombre de sucursal</strong></label>
                    <input id="name-field" value="" class="form-control" name = "name" type="text" required pattern="[0-9a-zA-Z-ñÑáéíóúÁÉÍÓÚ \s]{2,48}" title="No se permiten símbolos en este campo"> 
                    </div>
