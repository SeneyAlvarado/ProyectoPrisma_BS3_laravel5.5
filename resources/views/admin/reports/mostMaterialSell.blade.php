...
<html>
  ...
  <body>
      <div style="padding:10px;" >
          <div class="card">
              <p class="card-header" style="text-align:left"><button onclick="generatePDF('{{$material->start}}','{{$material->end}}')">Descargar reporte en PDF</button></p>
              <div class="card-body">
      ...
      <div class="col-md-12 col-md-offset-2" id="report" >
          ...
          <div id="element-to-print" align="center">
            <h6 align="left">Desde {{\Carbon\Carbon::parse($material->start)->format('d/m/Y')}} hasta {{\Carbon\Carbon::parse( $material->end)->format('d/m/Y') }}</h6>
