                ...
                <div class="">
					<form action="{{ url('saveVisit') }}" method="POST">
						...
						<div class="row justify-content-center">
							...
							<input class="form-control" placeholder="Nombre cliente" type="text" name="client_name" id="client_name-field" value="{{old('client_name')}}" required />´
							...
							<div class="col-md-5 col-md-offset-2" style="margin-top:15px;">
								...
								<input class="form-control" placeholder="Teléfono" type="text" name="phone" id="number" value="{{old('phone')}}" />
							</div>
							<div class="col-md-5 " style="margin-top:15px;">
								<label for="email-field"><strong>Correo electrónico</strong></label>
								<input class="form-control" placeholder="Correo electrónico" type="email" name="email" id="email-field" value="{{old('email')}}" />
							</div>
							<div class="col-md-10 col-md-offset-2" style="margin-top:15px;">
								<label for="details-field"><strong>Detalles</strong></label>
								<textarea class="form-control" type="text" placeholder="Detalles de la visita"  name="details" id="details-field" value="" rows="5" style="resize: none;" required>{{old('details')}}</textarea>
							</div>
						</div>
						<br>
						<div class="row justify-content-center">
