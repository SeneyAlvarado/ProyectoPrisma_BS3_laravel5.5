            ...
            <div class="container-fluid">
                <div class="">
                    <form method='POST' action="javascript:formValidation();" id="orderForm" autocomplete="off">
                        ...
                        <input type='hidden' id='hiddenDateCR' value='{{\Carbon\Carbon::now('America/Costa_Rica')->addDay(7)->format('d/m/Y')}}'>
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                ...
                                <div id="hideName" style="display:block;">
                                    <label style="margin: 0;"><strong>Nombre:&nbsp</strong></label><label id="client_name" value=" " type="text" name="client_name">{{$ownerName}}</label>
                                </div>
                                <div id="hideId" style="display:block;">
                                    <label style="margin: 0;"><strong>Cédula:&nbsp</strong></label><label id="identification" value=" " type="text" name="identification">{{$owner->identification}}</label>
                                </div>
                                <div id="hidePhone" style="display:block;">
                                    <label style="margin: 0;"><strong>Teléfono:&nbsp</strong></label><label id="phone" value=" " type="text" name="phone">{{$phone}}</label>
                                </div>
                                <div id="hideEmail" style="display:block;">
                                    <label style="margin: 0;"><strong>Correo:&nbsp</strong></label><label id="email" value=" " type="text" name="email">{{$email}}</label>
                                </div>
                                <input type="hidden" value="{{$owner->id}}" class="form-control" id="client_owner" name="client_owner">
                                <input type="hidden" value="{{$order->client_contact}}" class="form-control" id="client_contact" name="client_contact">
                        ...
                        <div class="row justify-content-center" style="margin-top:20px;">
                            <div class="table-responsive">
                                <div id="tableDiv" style="display:">
                                    <table style="overflow: visible !important;" class="table table-striped table-bordered table-drop table-condensed table-hover compact order-column" id="worksTable">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" id="product0{{$rowCount}}" value="{{$work->product_id}}">
                                                    ...
                                                    <div class="row" style="width: 95%">
                                                        ...
                                                        <div class="col-md-1" style="margin-top: 10px;">
                                                            <a href="{{route('downloadFile', $work->file_id)}}">
                                                                <span class="glyphicon glyphicon-download-alt" style="font-size:18px; color: crimson;" title="Descargar archivo del trabajo"></span>
                                                            </a>
                                                        </div>
                                                        @else
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 align-self-center">
                                                ...
                                                <select size="4" style="margin-top:8px;" class="form-control" id="product_branch" name="product_branch">
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-center" style="margin-top:20px;">
                                            <div class="col-md-10">
                                                ...
                                                <textarea class="form-control" onkeyup="countCharsAddModal(this);" value="" rows="4" id="observation_add" name="observation_add"></textarea>
                                            ...
                                            <div class="col-md-3 offset-md-5">
                                                ...
                                                <div class="input-group " id="priority_add">
                                                    ...
                                                    <span class="radio">
                                                        <label>Sí</label>
                                                        <label>
                                                            <input id="priority_add1" type="radio" value="1" class="radiobox" name="priority_add">
                                                        </label>

                                                        <label>
                                                            <label style="margin-left:20px;">No</label>
                                                            <input id="priority_add0" type="radio" value="0" class="radiobox" name="priority_add" checked>
                                                        </label>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-4 col-md-offset-2" style="margin-top:5px;  ">
                                            <a class='btn btn-success btn-block' onclick="addWorkToTable();" type='submit'>Agregar a la orden</a>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive" style="text-align:center">
                    <div id="tableDiv" style="display:">
                        <table style="overflow: visible !important;" class="table table-striped table-sm table-bordered table-drop table-condensed table-hover compact order-column" id="tableClients">
                            <thead>
...
<div class="modal fade" id="savingModal" tabindex="-1" role="dialog" aria-labelledby="loadMeLabel" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer" style=" display: flex; justify-content: center;">
                <button type="button" id="cancelOrderPost" onclick="cancelOrderPost();" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
    </div>
</div>
