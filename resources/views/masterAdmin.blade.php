        ...
        The sidebar isn't proper for smaller screens imo, so this dropdown menu can keep all the useful sidebar itens exclusively for smaller screens  -->
            <li class=" nav-item dropdown d-sm-block d-md-none">
              ...
              <div class="dropdown-menu" aria-labelledby="smallerscreenmenu" style=" background-color:#96183a; border:0px;">
                <a class="dropdown-item" style="color:white" href="#">Trabajos <span class="glyphicon glyphicon-briefcase fa-fw mr-3 icon-trabajos" ></span></a>
                <a class="dropdown-item" style="color:white" href="{{url('states')}}">Estados<span class="glyphicon glyphicon-stats fa-fw mr-3 icon-estados"></span></a>
                <a class="dropdown-item" style="color:white" href="{{url('materials')}}">Materiales<span class=" 	glyphicon glyphicon-list-alt fa-fw mr-3 icon-materiales"></span></a>
                <a class="dropdown-item" style="color:white" href="{{url('products')}}">Productos<span class=" 	glyphicon glyphicon-list-alt fa-fw mr-3 icon-productos"></span></a>
                ...
                <a class="dropdown-item" style="color:white" href="{{ url('user') }}">Cuentas<span class="glyphicon glyphicon-user fa-fw mr-3 icon-cuentas"></span></a>
                <a class="dropdown-item" style="color:white" href="{{url('branch')}}">Sucursales<span class="glyphicon glyphicon-flag fa-fw mr-3 icon-sucursales"></span></a>
