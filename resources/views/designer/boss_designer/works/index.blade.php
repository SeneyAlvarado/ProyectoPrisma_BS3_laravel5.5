            ...
            <table class="table table-bordered table-condensed table-hover compact " id="tablaDatos">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td class="text-center" style="min-width:150px;">
                            <div class="dropdown" style="display: block">
                                <button class="btn btn-secondary btn-sm dropdown-toggle"
                                    id="dropDesigner{{$work->work_id}}" data-target="#drop-designers" href="#"
                                    value="{{$actualDesignerID}}" role="button" id="dropdownMenuLink"
                        ...
                        @if ($work->color == "red")
                        <td class="text-center"><strong>{{$work->time_left}} </strong><span style="color:#C20202"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                ...
                                <textarea class="form-control" value="" rows="5" id="comment" name="address" readonly
